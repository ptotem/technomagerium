...
class PuzzlesControllerTest < ActionController::TestCase
  ...
  test "should create puzzle" do
    assert_difference('Puzzle.count') do
      post :create, puzzle: { combo: @puzzle.combo, target: @puzzle.target, theme: @puzzle.theme, writeup: @puzzle.writeup }
    end
  ...
  test "should update puzzle" do
    put :update, id: @puzzle, puzzle: { combo: @puzzle.combo, target: @puzzle.target, theme: @puzzle.theme, writeup: @puzzle.writeup }
    assert_redirected_to puzzle_path(assigns(:puzzle))
  end
